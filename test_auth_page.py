...
def test_phone_valid_login(selenium):
    ...
    page = AuthPage(selenium)
    page.phone.send_keys('+79043426602')
    page.passw.send_keys('Yflt;ysq_gfh0km')
    page.uncheck_box()
    page.btn_click()
...
def test_email_valid_login(selenium):
    ...
    page.email.send_keys("ya.pionerka2011@yandex.ru")
    page.passw.send_keys("Yflt;ysq_gfh0km")
    page.uncheck_box()
    page.btn_click()
...
def test_phone_unregistered_login(selenium):
    ...
    page = AuthPage(selenium)
    page.phone.send_keys('+79053527612')
    page.passw.send_keys("Refr1gerat0r")
    page.uncheck_box()
    page.btn_click()
...
def test_email_unregistered_login(selenium):
    ...
    page = AuthPage(selenium)
    page.tab_email_click()
    page.email.send_keys('lesyaK@mail.ru')
    page.passw.send_keys("Refr1gerat0r")
    page.uncheck_box()
    page.btn_click()
    error_message = selenium.find_element(By.ID, "form-error-message")
